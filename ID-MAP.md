...
| **B45 ≈ E1** — Support-Triage Rollout / support-drafting tool | Same person, same surface. B45 says "roll out the V1 that exists"; E1 says nothing has been built. **Unreconciled — don't quote either until it's settled** |
| **B16 = V1** — Oil & Gas CRM | V2 and V3 are phases of B16, not separate builds |
| **B22 = V4** — WhatsApp prospect capture | Both claim a V1 exists; there's no artifact or run evidence. **Treat as unverified** |
...
- **51** — B-numbers issued in the main backlog today
- **~62** — every distinct build including MindLab, the VGN finance set, and the EduTech cases
